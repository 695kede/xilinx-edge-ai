...
#working directory
work_dir=$HOME/ML/cifar10/deephi/miniGoogleNet/pruning/quantiz #$(pwd)
#path of float model
model_dir=${work_dir}
#output directory
...
ln -nsf $HOME/ML/cifar10/input/cifar10_jpg/calib $HOME/ML/cifar10/deephi/miniGoogleNet/pruning/quantiz/data/calib
