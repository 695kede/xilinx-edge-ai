...
'''
History:
- originally written by Adrian Rosebrock on 11 February 2019 in https://www.pyimagesearch.com/2019/02/11/fashion-mnist-with-keras-and-deep-learning/
- modified by daniele.bagni@xilinx.com on 9 June 2019, following the instructions of Mark Harvey's "How to freeze a Keras model for use with DNNDK"
'''

# USAGE
# python train_fashion_mnist.py -w keras_model/miniVggNet
