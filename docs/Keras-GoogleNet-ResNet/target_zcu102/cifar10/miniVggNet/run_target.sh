...
python2 ./check_runtime_top5_cifar10.py -i ./rpt/logfile_top5_miniVggNet.txt  2>&1 | tee ./rpt/top5_accuracy_cifar10_miniVggNet.txt


## launch script to check fps
source ./run_fps_miniVggNet.sh 2>&1 | tee ./rpt/fps_cifar10_miniVggNet.txt
