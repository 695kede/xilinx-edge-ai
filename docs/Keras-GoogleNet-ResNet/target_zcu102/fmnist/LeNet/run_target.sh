...
./LeNet 1 2>&1 | tee ./rpt/logfile_top5_LeNet.txt

## launch python script to check top-5 accuracy
python2 ./check_runtime_top5_fashionmnist.py -i ./rpt/logfile_top5_LeNet.txt  2>&1 | tee ./rpt/top5_accuracy_fmnist_LeNet.txt


## launch script to check fps
source run_fps_LeNet.sh 2>&1 | tee ./rpt/fps_fmnist_LeNet.txt
