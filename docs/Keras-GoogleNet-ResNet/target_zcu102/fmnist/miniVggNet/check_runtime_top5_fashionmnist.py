# USAGE
# python2 check_runtime_top5_cifar10tf.py -i ./rpt/logfile_top5.txt 2>&1 | tee ./rpt/cifar10_top5_accuracy_on_target_board.txt

# It checks the top-1 and top-5 accuracy obtained at runtime by DeePhi DPU, by analysis of the related logfile.
# It works only with python2, which is the one in the SD CARD OS of target board. 
